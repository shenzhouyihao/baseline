...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_visuals', action='store_true', help='save test prediction PDFs', default=False)
    ...
    parser.add_argument('--n_period', type=int, default=3, help='for RAFT')
    parser.add_argument('--topm', type=int, default=20, help='for RAFT')
