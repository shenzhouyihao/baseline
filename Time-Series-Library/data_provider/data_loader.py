...
def run_augmentation_single(*args, **kwargs):
    from utils.augmentation import run_augmentation_single as augment
...
def hf_hub_download(*args, **kwargs):
    from huggingface_hub import hf_hub_download as huggingface_download

    return huggingface_download(*args, **kwargs)
...
def _load_uea_helpers():
    from data_provider.uea import Normalizer, interpolate_missing, subsample
    from sktime.datasets import load_from_tsfile_to_dataframe

    return Normalizer, interpolate_missing, subsample, load_from_tsfile_to_dataframe
...
class Dataset_M4(Dataset):
    def __init__(self, args, root_path, flag='pred', size=None,
        ...
        M4Dataset, M4Meta = _load_m4_types()
        self.M4Dataset = M4Dataset
    ...
    def __read_data__(self):
        ...
        if self.flag == 'train':
            dataset = self.M4Dataset.load(training=True, dataset_file=self.root_path)
        else:
            dataset = self.M4Dataset.load(training=False, dataset_file=self.root_path)
...
class UEAloader(Dataset):
    ...
    def __init__(self, args, root_path, file_list=None, limit_size=None, flag=None):
        ...
        self.root_path = root_path
        self.flag = flag
        normalizer_cls, interpolate_missing_fn, subsample_fn, load_ts_fn = _load_uea_helpers()
        self.Normalizer = normalizer_cls
        self.interpolate_missing = interpolate_missing_fn
        self.subsample = subsample_fn
        self.load_from_tsfile_to_dataframe = load_ts_fn
